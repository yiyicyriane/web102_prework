...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${unfundedCount} ${
...
const runnerUpEl = document.createElement("h3");
runnerUpEl.textContent = runnerUp.name;
